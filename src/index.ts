...
import { noteRouter } from "./router/application/note";
import { NoteDir } from "./business/note/noteManager";
...
export const address =
  process.env.NODE_ENV === "production" ? "qy-lrr-home.cn" : "127.0.0.1";
...
async function initFiles() {
  ...
  let note = path.join(RootDir, NoteDir);
